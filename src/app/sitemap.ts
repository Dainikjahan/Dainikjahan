...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = ["", "/latest", "/about", "/contact", "/privacy", "/category/national", "/category/politics", "/category/mymensingh", "/category/economy", "/category/international", "/category/sports", "/category/health", "/category/education", "/category/culture", "/category/opinion", "/category/special-report"];
