    ...
    <header className="site-header">
      <div className="container">
        <div className="topline">
          <div>{today}</div>
          <div className="topline-right"><span>ময়মনসিংহ</span><span>ঢাকা</span><span>সারাদেশ</span><span>আবহাওয়া</span></div>
        </div>
        ...
        <nav className="nav" aria-label="প্রধান নেভিগেশন">
          ...
          <Link href="/category/special-report">বিশেষ প্রতিবেদন</Link>
          <Link href="/opinion">মতামত</Link>
          <Link href="/gallery">ছবিঘর</Link>
